...
public abstract class PowerTeam extends Power {
    public PowerTeam(String selectedStyle, String blendColor, String imageName, String primaryIcon, String name, Integer radius, Integer value, String effectName, Integer effectvalue) {
    ...
    public void applyDefenceChange(Minion minion) {
        if (getValue() != null && model.isCurrentPlayerMinion(minion)) model.restoreMinion(minion, getValue());
    }
