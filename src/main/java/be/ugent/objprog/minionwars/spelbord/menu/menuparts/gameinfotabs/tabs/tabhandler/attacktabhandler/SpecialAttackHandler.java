...
public class SpecialAttackHandler implements TabHandler {

    public void handleUIUpdate(MenuModel model) {
        ToggleButton button = model.getTabs().attack().getSpecialeAanval();
    ...
    public boolean canHandle(MenuModel model) {
        ...
        return selected != null && selected.isNotAttacked() && selected.canSpecialAttack() && model.canAttack();
    }
}